...
Since the COVID, the conference has moved to an online format where the videos are published online to be available to a broad audience. However, after the contact restrictions were lifted Apple decided to restart the in-person component of the WWDC. 
